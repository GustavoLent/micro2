...
start:
	...
	ldw   r5, 4(r4)   /* r5 is a counter, initialize it with n */
	                  /* it was added 4 because the second element in the list its his size */
	addi  r6, r4, 8   /* r6 points to the first number */
	                  /* it was added 8 because the list starts in the third element */
	ldw   r7, (r6)    /* r7 holds the largest number found so far (first of the list) */
